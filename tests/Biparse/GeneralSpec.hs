...
--  fb "takeUni"
--   (takeUni 'a' :: Iso LineColumn FM ErrorPosition Maybe (Position Text) Char)
--   (\f -> do
...
--
--    fb "LineColumn"
--      (takeDi 'x' 1 :: Iso LineColumn FM ErrorPosition Maybe (Position Text) Int)
--      (\f -> do
...
--
--    fb "LineColumn"
--      (takeNot 'A' :: Iso LineColumn FM ErrorPosition Maybe (Position String) Char)
--      (\f -> do
...
--
--  fb "takeWhile"
--    (takeWhile (/= 'x') :: Iso LineColumn FM ErrorPosition IO (Position Text) Text)
--    (\f -> do
--      it "empty" do
...
--
--  fb "pad"
--    (pad 4 'x' naturalBaseTen :: Iso LineColumn FM ErrorPosition IO (Position Text) Int)
--    (\f -> do
--      it "no pad" do
...
--
--  fb "breakWhen"
--    (breakWhen $ stripPrefix "ab" :: Iso LineColumn FM ErrorPosition IO (Position (Seq Char)) (Seq Char))
--    (\f -> do
--      it "empty" do
--        f "" `shouldBe` Right (mempty, "")
--
...
--    
--    fb "LineColumn"
--      (stripPrefix "abc" :: Unit LineColumn (Position Text) FM ErrorPosition IO)
--      (\f -> do
