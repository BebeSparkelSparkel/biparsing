...
import Data.MonoTraversable (MonoFoldable, headMay, Element)
import Data.MonoTraversable.Unprefixed (for_, null, length, toList)
import Data.Monoid (Monoid(mempty))
import Data.Ord ((>))
import Data.Semigroup ((<>))
import Data.Sequences (IsSequence, initMay, tailMay, singleton, cons, span, replicate, Index, fromList, initDef)
